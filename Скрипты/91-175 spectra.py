...
def main():
    c15d = "../Измерения/Со спектрометра Клинкова/24.05.24/175 обесцв.csv"
    c15l = "../Измерения/Со спектрометра Клинкова/24.05.24/175 окраш.csv"
    c16d = "../Измерения/Со спектрометра Клинкова/09.02.24/091/dark.csv"
    c16l = "../Измерения/Со спектрометра Клинкова/09.02.24/091/transparent.csv"
    ...
    txt = ["Гладкий слой ITO + 20 нм NiO","Гладкий слой ITO + 20 нм NiO", "Пористый ITO толщиной 250 нм + 20 нм NiO", "Пористый ITO толщиной 250 нм + 20 нм NiO"]
    for df in dfs:
        if i % 2 == 0:
    ...
    fig.savefig("../91+175 образец спектры", dpi=500)
