...
s1 = per_cycle * 1
s2 = per_cycle * 11
ax.plot(sample.voltage, list(map(lambda x: 1000 * x / 5, sample.current)), 'b-')

arrow = ax.arrow(0.37, 0.2, 0.04, 0.25, label="cycle increase")
plt.annotate("cycle increase", (0.37, 0.2), (0.25, 0.2))

ax.set_aspect(0.5)
#ax.set_title("Sample 091")

ax.set_xlabel(r"Sample potential, $V$")
...
fig.savefig("../Картинки/ЦВА/099 первые 10 циклов.png", dpi=300)
