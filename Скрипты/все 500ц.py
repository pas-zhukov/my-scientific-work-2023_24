...
def main():
    ...
    c1800l = "../Измерения/Со спектрометра Клинкова/27.03.24/181/ц501 окр.csv"
    c1800d = "../Измерения/Со спектрометра Клинкова/27.03.24/181/ц501 обесцв.csv"
    ...
    fig.savefig("../Картинки/Спектры/все образцы 500ц (091-900ц)", dpi=500)
