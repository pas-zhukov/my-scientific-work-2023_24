...
line1, = ax.plot(sample.voltage[-1800:-1], list(map(lambda x: 1000 * x / 5, sample.current))[-1800:-1], color='aqua', label="NW250 10 cycles")
line2, = ax.plot(sample100.voltage[-1800:-1], list(map(lambda x: 1000 * x / 5, sample100.current))[-1800:-1], color='deepskyblue', label="NW250 100 cycles")
line3, = ax.plot(sample1000.voltage[-1800:-1], list(map(lambda x: 1000 * x / 5, sample1000.current))[-1800:-1], color='teal', label="NW250 1000 cycles")
line4, = ax.plot(sample1800.voltage[-1800:-1], list(map(lambda x: 1000 * x / 5, sample1800.current))[-1800:-1], color='midnightblue', label="NW250 1800 cycles")
