...
def main():
    c15d = "../Измерения/Со спектрометра Клинкова/27.03.24/181/ц501 окр.csv"
    c15l = "../Измерения/Со спектрометра Клинкова/27.03.24/181/ц501 обесцв.csv"
    ...
    j = 0
    k=0
    colors = ["deepskyblue", "r", "r", "maroon", 'green', 'orange']
    txt = [ "Пористый ITO - 700 нм; NiO - 20 нм;\n Добавлен проводящий подслой","Пористый ITO - 700 нм; NiO - 20 нм;\n Добавлен проводящий подслой", "Пористый ITO - 700 нм; NiO - 20 нм", "Пористый ITO - 700 нм; NiO - 20 нм" ]
    for df in dfs:
        if i % 2 == 0:
    ...
    fig.savefig("../181+ 99 образец спектры (цикл уточнить)", dpi=500)
