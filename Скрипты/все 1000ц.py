...
def main():
    c15d = "../Измерения/Со спектрометра Клинкова/28.02.24/091/ц1000 обесцв сост.csv"
    c15l = "../Измерения/Со спектрометра Клинкова/28.02.24/091/ц1000 окр сост.csv"
    ...
    c900d = "../Измерения/Со спектрометра Клинкова/28.02.24/099/ц1000 окр сост.csv"
    c900l = "../Измерения/Со спектрометра Клинкова/28.02.24/099/ц1000 обесцв сост.csv"
    c1000d = "../Измерения/Со спектрометра Клинкова/24.05.24/103 ц1000 окр.csv"
    c1000l = "../Измерения/Со спектрометра Клинкова/24.05.24/103 ц1000 обес.csv"
    c1800l = "../Измерения/Со спектрометра Клинкова/24.05.24/181 500ц окр.csv"
    c1800d = "../Измерения/Со спектрометра Клинкова/24.05.24/181 500ц обесцв.csv"


    mes = [c15l, c15d,  c900l, c900d, c1000l, c1000d, c1800l, c1800d, ]
    dfs = []
    for m in mes:
    ...
    j = 0
    k=0
    colors = ["deepskyblue",  "r", "maroon",  'orange']
    txt = ["091","091",  "099","099", "103", "103",  "181","181", ]
    for df in dfs:
        if i % 2 == 0:
    ...
    fig.savefig("../Картинки/Спектры/все образцы 1000ц", dpi=500)
